...
pairwise.adonis2_noPhaeo_Genus_WT_dTDA_dat <- pairwise.adonis2_noPhaeo_Genus[[3]]
...
#Figure 1 ----
library(cowplot)
pdf(file = "Figures/Figure_1_NMDS_noPhaeo.pdf",   # The directory you want to save the file in
...
tiff("Figures/Figure_1_NMDS_noPhaeo.tiff", units="in", width=8.5, height=9, res=300)
